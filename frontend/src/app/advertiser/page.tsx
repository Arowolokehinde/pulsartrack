    ...
    <ErrorBoundary name="AdvertiserPage" resetKeys={[activeTab]}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        {isStatsLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            {[
              { icon: BarChart3, label: 'Active Campaigns', value: stats?.active_campaigns?.toString() || '0', color: 'blue' },
              { icon: Eye, label: 'Total Impressions', value: stats?.total_views?.toString() || '0', color: 'green' },
              { icon: MousePointer, label: 'Total Clicks', value: '0', color: 'purple' },
              { icon: TrendingUp, label: 'Total Spent', value: stats ? formatXlm(stats.total_spent) : '0 XLM', color: 'orange' },
